...
pub fn get_available_models() -> Vec<ModelDef> {
    vec![
        ...
        ModelDef {
            ...
            download_url: // TODO(F015): Update CDN URL when server-side rebrand is complete
            "https://meetily.towardsgeneralintelligence.com/models/gemma-3-1b-it-Q8_0.gguf".to_string(),
            size_mb: 1019,
            context_size: 32768, 
            layer_count: 26,     
        ...
        ModelDef {
            ...
            template: "gemma3".to_string(),
            download_url: // TODO(F015): Update CDN URL when server-side rebrand is complete
            "https://meetily.towardsgeneralintelligence.com/models/gemma-3-4b-it-Q4_K_M.gguf".to_string(),
            size_mb: 2374,
