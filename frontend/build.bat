@echo off
REM Tandem Build Script for Windows
...
echo 🚀 Building Tandem application...
...
echo.
echo DESCRIPTION:
echo   This script builds the Tandem Tauri application for Windows.
