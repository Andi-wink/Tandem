# GPU-accelerated development script for Tandem (Windows PowerShell)
# Automatically detects and runs in development mode with optimal GPU features

Write-Host "GPU-Accelerated Development Mode for Tandem" -ForegroundColor Blue
Write-Host ""
...
Write-Host ""
Write-Host "Starting Tandem in development mode..." -ForegroundColor Blue
Write-Host ""
