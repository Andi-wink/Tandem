...
import { ArrowLeft, Settings2, Mic, Database as DatabaseIcon, SparkleIcon, Terminal, FolderGit2, BookMarked } from 'lucide-react';
...
const TABS = [
  ...
  { value: 'dictionary', label: 'Dictionary', icon: BookMarked },
              ...
              {TABS.map((tab, index) => {
                ...
                return (
                  <TabsTrigger
                    ...
                    className="flex items-center gap-2 px-6 py-4 bg-transparent rounded-none border-0 data-[state=active]:bg-transparent data-[state=active]:text-blue-600 dark:data-[state=active]:text-blue-400 data-[state=active]:shadow-none text-muted-foreground hover:text-foreground relative z-10"
                  >
