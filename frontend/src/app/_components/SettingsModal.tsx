...
export function SettingsModals({
  ...
  return <>
      ...
      <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
        <div className="bg-background rounded-lg shadow-xl max-w-4xl w-full max-h-[90vh] overflow-hidden flex flex-col">
          ...
          <div className="flex-1 overflow-y-auto p-6 space-y-8">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <div className="flex space-x-2">
                    <select
                      className="px-3 py-2 text-sm bg-background border border-border rounded-md shadow-sm focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500"
                ...
                {modelConfig.provider === 'ollama' && (
                  <div>
                    ...
                    {error && (
                      <div className="bg-red-100 dark:bg-red-900/20 border border-red-400 dark:border-red-800/30 text-red-700 dark:text-red-300 px-4 py-3 rounded mb-4">
                        {error}
                      </div>
                    )}
                    <div className="grid gap-4 max-h-[400px] overflow-y-auto pr-2">
                      {models.map((model) => (
                        <div
                          key={model.id}
                          className={`bg-card p-4 rounded-lg shadow cursor-pointer transition-colors ${modelConfig.model === model.name ? 'ring-2 ring-blue-500 bg-blue-50' : 'hover:bg-muted'
                            }`}
            ...
            <div className="border-t pt-8">
              <h4 className="text-lg font-semibold text-foreground mb-1">AI Assistant (Claude)</h4>
    ...
    {modals.errorAlert && (
      <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
        <Alert className="max-w-md mx-4 border-red-200 dark:border-red-800/30 bg-background shadow-xl">
    ...
    {modals.chunkDropWarning && (
      <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
        <Alert className="max-w-lg mx-4 border-yellow-200 dark:border-yellow-800/30 bg-background shadow-xl">
