...
export function BluetoothPlaybackWarning({
  ...
  return (
    <Alert
      className="mb-4 border-yellow-500 bg-yellow-50 text-yellow-900 dark:bg-yellow-950 dark:text-yellow-100 dark:border-yellow-700"
      role="alert"
      aria-live="polite"
    >
      ...
      <div className="flex items-start justify-between w-full">
        <div className="flex-1">
          ...
          <AlertDescription className="text-yellow-800 dark:text-yellow-200 mt-1">
            ...
            <br />
            <a
              href="https://github.com/your-org/tandem/blob/main/BLUETOOTH_PLAYBACK_NOTICE.md"
              target="_blank"
        ...
        <Button
          ...
          className="ml-4 h-6 w-6 text-yellow-700 hover:text-yellow-900 hover:bg-yellow-100 dark:text-yellow-300 dark:hover:text-yellow-100 dark:hover:bg-yellow-800"
