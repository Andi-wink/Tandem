...
const HOMEBREW_PATHS = [
  '/opt/homebrew/var/tandem/meeting_minutes.db',  // Apple Silicon (M1/M2/M3)
  '/usr/local/var/tandem/meeting_minutes.db',      // Intel Macs
];
        ...
        <div className="flex-1">
          ...
          <div className="flex gap-2">
            <button
              ...
              className="flex-1 flex items-center justify-center gap-2 px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 disabled:bg-muted-foreground disabled:cursor-not-allowed transition-colors"
            >
              {isImporting ? (
                <>
