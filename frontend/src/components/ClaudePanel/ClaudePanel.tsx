...
export function ClaudePanel() {
  ...
  return (
    <>
      <div
        {...panelDropHandlers}
        className={`fixed right-0 top-0 bottom-0 w-[420px] bg-background border-l border-border shadow-lg z-40 flex flex-col transition-transform duration-200 ${isPanelOpen ? 'translate-x-0' : 'translate-x-full pointer-events-none'} ${isPanelDropOver ? 'ring-2 ring-blue-400 ring-inset' : ''}`}
      >
        {/* Header */}
