...
When **reviewing recordings** in Tandem, we recommend using **computer speakers** or **wired headphones** rather than Bluetooth headphones for accurate playback.
...
1. **Tandem records at 48kHz** (professional audio standard)
...
- ❌ **Reviewing Tandem recordings** - Use wired/speakers instead
...
### This is Not a Tandem Bug

The issue is in **macOS's Bluetooth audio stack**, not in Tandem's recording engine.
...
**A**: This is a macOS/Bluetooth limitation, not a Tandem bug. We've correctly recorded at 48kHz.
...
**A**: Yes! Tandem now shows a warning when Bluetooth headphones are active during playback.
...
**Applies To**: Tandem v0.0.5+ on macOS
