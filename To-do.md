...
- [ ] Known limitation: on meeting-details, Regenerate builds windows from the PAGINATED transcripts currently loaded, not guaranteed the full transcript for very long meetings; the stop-path enhance uses the complete in-memory transcripts.
