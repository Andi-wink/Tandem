# Building Tandem from Source

This guide provides detailed instructions for building Tandem from source on different operating systems.
...
This guide helps you build Tandem on Linux with **automatic GPU acceleration**. The build system detects your hardware and configures the best performance automatically.
...
```
src-tauri/target/release/bundle/appimage/Tandem_<version>_amd64.AppImage
```
