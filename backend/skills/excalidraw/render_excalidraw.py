...
def render(
    ...
    try:
        ...
        print("Run: cd backend/skills/excalidraw && uv sync && uv run playwright install chromium", file=sys.stderr)
        sys.exit(1)
...
def main() -> None:
    ...
    parser.add_argument("file", type=Path, help="Path to .excalidraw file")
    ...
    render(args.file, args.output, args.scale, args.width)
